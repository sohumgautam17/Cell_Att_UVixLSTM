# python main.py --device=cuda:2 --model=xlstm --loss=all --batch=32
# python main.py --inference --model=xlstm --checkpoint=saved_best_0.0001_32_5_0.01_xlstm_False_all --device=cuda:2
